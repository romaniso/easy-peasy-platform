...
function Cheetsheet({ topic, level, content }) {
  ...
  return (
    <section className="border-l px-12 py-10 flex-auto w-1/5 transition-all overflow-y-auto blur-sm hover:blur-none scrollbar scrollbar-thin scrollbar-thumb-orange-300 scrollbar-track-indigo-50">
      <header>
