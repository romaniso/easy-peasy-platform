...
function Navbar() {
  ...
  return (
    <header className="shadow-md w-full fixed top-0 left-0 z-10">
      <nav className="md:flex justify-between items-center bg-white py-2 md:px-10 px-7 ">
        {/* LOGO */}
        <NavLink to="/">
        ...
        {/* MENU */}
        <ul
          className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 px-9 transition-all duration-500 ease-in shadow-md md:shadow-none ${
