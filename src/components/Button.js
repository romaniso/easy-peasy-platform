...
function Button({children, primary, secondary, success, warning, danger, outline, rounded, ...rest}){
    const classes = className("py-2 px-5 cursor-pointer transition-colors border shadow", {
        ...
        "border-yellow-500 text-yellow-500 hover:text-white hover:bg-yellow-500" : outline && warning,
