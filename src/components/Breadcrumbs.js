...
function Breadcrumbs() {
    ...
    const crumbs = pathname
        ...
        .map((crumb, index, arr) => {
            currentLink += `/${crumb}`
            return (
                <div className='inline-flex items-center gap-1 mr-2 md:mr-4 text-indigo-800/75 dark:text-indigo-300/90 text-base md:text-lg hover:text-orange-500 hover:dark:text-orange-500 transition-opacity' key={crumb}>
