    ...
    return (
        <div className='h-full md:p-12'>
            <Panel className='bg-white flex md:flex-row flex-col !p-0 rounded-none md:rounded-md overflow-hidden h-full w-full'>
                <div className='flex-shrink h-1/5 md:h-full md:basis-2/5 flex flex-col justify-center items-center bg-gradient-to-r from-orange-300 to-orange-200 dark:from-stone-800 dark:to-stone-600 p-3 md:p-5'>
                    <ProfileAvatar/>
