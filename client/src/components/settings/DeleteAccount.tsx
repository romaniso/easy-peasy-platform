...
export const DeleteAccount: React.FC  = () => {
    ...
    const handleDeleteAccount = async () => {
        ...
        try {
            const response = await axiosPrivate.delete(`${DELETE_ACCOUNT_URL}/${auth.user}`, {
    ...
    return (
        <section className='md:col-span-2 flex justify-between items-center'>
            ...
            <Button danger rounded small className='whitespace-nowrap' onClick={() => setShowModal(!showModal)}>
