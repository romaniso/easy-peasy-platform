...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  const inputClasses = classNames(
    ...
    {
      "focus:border-orange-500 text-indigo-700 dark:text-indigo-300 dark:bg-transparent ":
        primary,
  ...
  const labelClasses = classNames(
    "absolute left-3 top-1/2 -translate-y-1/2 cursor-text peer-focus:text-xs peer-focus:-top-3 peer-focus:left-0 peer-valid:text-xs peer-valid:-top-3 peer-valid:left-0 transition-all duration-500",
    {
      ...
      "text-indigo-800 dark:text-indigo-400 dark:peer-focus:text-orange-500 peer-focus:text-orange-500 peer-valid:text-indigo-500":
        secondary,
      "peer-valid:text-lg peer-valid:text-indigo-700 dark:peer-valid:text-indigo-300 peer-focus:text-lg -translate-y-2/3":
        lg && secondary,
