              ...
              (subItem as AvatarItem).eventHandler ? (
                <li
                  className={`
                                        ...
                                        ${
                                          (subItem as AvatarItem).isLogoutBtn &&
                                          "text-red-700 md:bg-red-500/20 hover:bg-red-500/40"
                                        }
                                        ${avatar && "!px-1"}
                                        `}
                ...
                >
                  {subItem.icon && (
                    <span className="min-w-3">{subItem.icon}</span>
                  )}
                ...
                <NavLink
                  key={subItem.label}
                  to={(subItem as SubmenuItem).path}
                  onClick={() => setIsCollapsed(!isCollapsed)}
                >
                  <li
                    className={`
