...
const Button: React.FC<ButtonProps> = ({
    ...
    const classes = className(
        ...
        {
            "py-2 px-5 bg-orange-400 dark:bg-orange-500 text-white hover:bg-orange-500 hover:dark:bg-orange-600": primary,
            ...
            "hover:bg-indigo-700 hover:!text-white hover:!dark:bg-indigo-600":  small && secondary,
        }
    );
    return (
        <button
