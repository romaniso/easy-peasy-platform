...
const Listening = () => {
    return (
        <>
            <header className='bg-white/90 dark:bg-black/90 md:bg-transparent dark:md:bg-transparent flex items-center md:gap-5 relative rounded-t-md md:rounded-md'>
                <div className='top-0 left-0 w-full h-full md:p-3 md:w-auto md:h-auto absolute md:static basis-0 md:basis-2/5 overflow-hidden self-stretch rounded-t-md md:rounded-md'>
                    <img src="https://picsum.photos/800/400" alt="" className='w-full h-full object-cover opacity-30 md:opacity-100'/>
                </div>
                <div className='basis-full md:basis-3/5 py-3 px-3 md:px-5 self-center relative z-10'>
                    ...
                    <WaveFormPlayer audioUrl='https://easy-peasy-audio-bucket.s3.eu-central-1.amazonaws.com/Building-and-maintaining-relationships-transcript.mp3' className='mr-2'/>
