...
const Listening: React.FC<ListeningProps> = ({audioUrl, title, description, image, level}) => {
    return (
        <>
            <div className='bg-white/90 dark:bg-black/90 md:bg-transparent dark:md:bg-transparent flex items-center md:gap-5 relative rounded-t-md md:rounded-md'>
                ...
                <div className='basis-full md:basis-3/5 py-3 px-3 md:px-5 self-center relative z-10'>
                    <span className='text-md font-bold font-mono text-indigo-700 absolute right-3 top-3 md:right-6 md:top-5 border border-indigo-500 px-1 py-0.5 md:px-2 md:py-1.5 rounded-md drop-shadow-md drop-shadow-purpleGlow'>{level}</span>
