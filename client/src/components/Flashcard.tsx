...
export const Flashcard = ({
  ...
  const cardClasses = `flex-grow self-stretch flip-card ${
    isFlipped ? "flipped" : ""
  } min-h-[280px] cursor-pointer hover:scale-105 transition-all duration-700`;
      ...
      <div className="flip-card-inner shadow-md rounded-md border dark:border-gray-500">
        <div className="flip-card-front text-center flex flex-col justify-between items-center">
          <div className="h-1/2 flex justify-center items-center">
            <p className="px-2 py-4 text-indigo-800 dark:text-indigo-200 font-bold">
              {question}
            </p>
          </div>
          <div className="w-full bg-stone-700 dark:bg-[#202020] h-1/2 flex justify-center items-center rounded-b-md">
            <p className="px-2 py-4 text-white dark:text-orange-600">
              {example}
            </p>
          </div>
        </div>
        <div className="flip-card-back flex flex-col items-center rounded-md relative">
          ...
          <img
            src={cardImage}
            alt=""
            className="w-full h-24 md:h-28 object-cover rounded-t-md"
          />
          <div className="basis-2/3 p-2 w-full flex flex-col justify-around items-start text-left">
            ...
            <div>
              <p className="mb-2 text-indigo-900 dark:text-indigo-300">
                {question}
              </p>
              <p className="text-sm italic text-indigo-500 dark:text-indigo-400">
                {example}
              </p>
            </div>
          </div>
